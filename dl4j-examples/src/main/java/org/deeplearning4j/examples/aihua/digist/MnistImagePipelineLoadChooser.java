package org.deeplearning4j.examples.aihua.digist;
...
public class MnistImagePipelineLoadChooser {
  ...
  public static final String DATA_PATH = "/data/ai/";//FilenameUtils.concat(System.getProperty("java.io.tmpdir"), "dl4j_Mnist/");
...
//    File file = new File(filechose);
    ...
    for(int i=1;i<2;i++){
        ...
        log.info("The file chosen was " + file);
